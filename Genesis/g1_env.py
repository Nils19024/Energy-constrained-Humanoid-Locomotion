...
class Go2Env:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False, camera=False):
        ...
        # names to indices
        self.motors_dof_idx = [joint.dof_start for joint in self.robot.joints]
        ...
        self.default_dof_pos = torch.tensor(
            [0 for joint in self.robot.joints],
            device=gs.device,
            dtype=gs.tc_float,
        )
