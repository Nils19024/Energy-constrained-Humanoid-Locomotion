...
class Env:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False):
        ...
        self.env_cfg["joint_names"] = [joint.name for joint in self.robot.joints]
        self.env_cfg["default_joint_angles"] = {joint.name: joint.init_qpos for joint in self.robot.joints}

        # names to indices
        self.motors_dof_idx = [self.robot.get_joint(name).dof_start for name in self.env_cfg["joint_names"]]
        print(f"Motor idx: {len(self.motors_dof_idx)}; {self.motors_dof_idx}")
