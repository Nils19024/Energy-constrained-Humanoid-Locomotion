...
class SafetyGymnasiumEnv(CMDP):
    ...
    _support_envs: ClassVar[list[str]] = [
        ...
        'SafetyHumanoidVelocity-v0', # NEW: Added SafetyHumanoidVelocity-v0
    ...
    # NEW: Method to call a method on the underlying vectorized environment
    def call(self, name: str, *args, **kwargs) -> Any:
        """Call a method on the underlying vectorized environment."""
